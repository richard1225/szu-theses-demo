...
\include{ttchapter/cnabstract}
\include{ttchapter/chapter01}
\include{ttchapter/chapter02}
\include{ttchapter/chapter03}
\include{ttchapter/chapter04}

%参考文献
\kaishu
\bibliographystyle{plain}
\addcontentsline{toc}{section}{参考文献} %向目录中添加条目，以章/section的名义
\bibliography{ref/tthesis.bib}
