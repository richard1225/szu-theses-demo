...
\begin{figure}[H]
  ...
  % label的位置也有讲究
  \begin{center}
    \includegraphics[width=6in]{cut_word_result.png}
    \caption{切好词的文档}
    \label{cut_word_file}
  \end{center}
\end{figure} 
...
\begin{figure}[H]
  ...
  % label的位置也有讲究
  \begin{center}
    \includegraphics[width=6in]{word_vec.png}
    \caption{词向量矩阵}
...
\begin{figure}[H]
  ...
  % label的位置也有讲究
  \begin{center}
    \includegraphics[width=4in]{text_process_flow.png}
