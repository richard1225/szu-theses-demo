...
\begin{flushleft}
	\zihao{3}
	\hspace{3cm}{\heiti{题目：}}      
	{\kaishu\underline{\quad\textbf{基于密度的空间文本聚类}\hspace{1.2cm}}}               \\
	\vspace{10bp}
	
	\hspace{3cm}{\heiti{姓名：}}      
	{\kaishu\underline{\hspace{2.8cm}\textbf{彭婷婷}\hspace{3.5cm}}}              \\
	\vspace{10bp}
	...
	\hspace{3cm}{\heiti{学号：}}      {\kaishu\underline{\hspace{2.4cm}\textbf{2015300091}\hspace{2.6cm}}}                   \\
	\vspace{10bp}
	
	\hspace{3cm}{\heiti{指导教师：}} 
	{\kaishu\underline{\hspace{1.8cm}\textbf{吴定明}\hspace{3.5cm}} }                         \\
	\vspace{10bp}
